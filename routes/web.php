...
//Ruta inicial
Route::get('/', [LoginController::class, 'redirigir']);

// Redirigir si se ingresa a ruta no permitida sin acceder
Route::get('login', [LoginController::class, 'redirigir'])->name('login');

//Rutas del login
Route::controller(LoginController::class)->group(function () {
    Route::get('acceder', 'showAcceder')->name('show.acceder');
    Route::post('acceder', 'iniciarSesion')->name('iniciar.sesion');
